...
if [ "${SYNOPKG_PKGNAME}" == "Minecraft" ]; then
  MINECRAFT_VER="1.8.4"
  DOWNLOAD_PATH="http://s3.amazonaws.com/Minecraft.Download/versions/${MINECRAFT_VER}"
  DOWNLOAD_FILE="minecraft_server.${MINECRAFT_VER}.jar"
...
postinst ()
{
  ...
  #agree to the eula
  echo "eula=true" > ${SYNOPKG_PKGDEST}/eula.txt
